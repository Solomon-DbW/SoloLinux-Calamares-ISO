...
from soloinstall.lib.disk.device_handler import device_handler
from soloinstall.lib.disk.fido import Fido2
from soloinstall.lib.disk.utils import get_lsblk_by_mountpoint, get_lsblk_info
from soloinstall.lib.models.device import (
	DiskEncryption,
...
from soloinstall.lib.models.packages import Repository
from soloinstall.lib.packages import installed_package
from soloinstall.lib.translationhandler import tr
from soloinstall.tui.curses_menu import Tui
...
class Installer:
	def __init__(
		...
		It also wraps :py:func:`~soloinstall.Installer.pacstrap` among other things.
		"""
	...
	def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: TracebackType | None) -> bool | None:
		if exc_type is not None:
			...
			Tui.print(tr('Please submit this issue (and file) to https://github.com/archlinux/soloinstall/issues'))
		...
		if not (missing_steps := self.post_install_check()):
			...
			warn('Submit this zip file as an issue to https://github.com/archlinux/soloinstall/issues')
		...
		if not arch_config_handler.args.skip_ntp:
			...
			while True:
				if not notified and time.time() - started_wait > 5:
					notified = True
					warn(tr('Time synchronization not completing, while you wait - check the docs for workarounds: https://soloinstall.readthedocs.io/'))
	...
	def drop_to_shell(self) -> None:
		...
		subprocess.check_call(['arch-chroot', self.target])
	...
	def _prepare_fs_type(
		...
		# https://github.com/archlinux/soloinstall/issues/1837
	...
	def minimal_installation(
		...
		#
		# https://github.com/archlinux/soloinstall/issues/880
		# https://github.com/archlinux/soloinstall/issues/1837
		# https://github.com/archlinux/soloinstall/issues/1841
	...
	def setup_swap(self, kind: str = 'zram') -> None:
		if kind == 'zram':
			...
			# We could use the default example below, but maybe not the best idea: https://github.com/archlinux/soloinstall/pull/678#issuecomment-962124813
	...
	def _get_kernel_params_partition(
		...
		if root_partition in self._disk_encryption.partitions:
			...
			if self._disk_encryption.hsm_device:
				...
				# https://github.com/archlinux/soloinstall/pull/1196#issuecomment-1129715645
	...
	def _get_kernel_params(
		...
		# https://github.com/archlinux/soloinstall/issues/881
	...
	def _add_systemd_bootloader(
		...
		# TODO: This is a temporary workaround to deal with https://github.com/archlinux/soloinstall/pull/3396#issuecomment-2996862019
	...
	def set_keyboard_language(self, language: str) -> bool:
		...
		if len(language.strip()):
			...
			# In accordance with https://github.com/archlinux/soloinstall/issues/107#issuecomment-841701968
			# Setting an empty keymap first, allows the subsequent call to set layout for both console and x11.
			from .boot import Boot

			with Boot(self) as session:
				os.system('systemd-run --machine=soloinstall --pty localectl set-keymap ""')
