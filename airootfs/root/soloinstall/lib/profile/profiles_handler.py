...
class ProfileHandler:
	...
	def parse_profile_config(self, profile_config: ProfileSerialization) -> Profile | None:
		...
		# 	from soloinstall.default_profiles.custom import CustomTypeProfile
		# 	custom_types = []
		#
		# 	for entry in custom:
		# 		custom_types.append(
		...
		if details:
			for detail in filter(None, details):
				# [2024-04-19] TODO: Backwards compatibility after naming change: https://github.com/archlinux/soloinstall/pull/2421
	...
	def install_gfx_driver(self, install_session: 'Installer', driver: GfxDriver) -> None:
		...
		if driver in [GfxDriver.NvidiaOpenKernel, GfxDriver.NvidiaProprietary]:
			...
			# Fixes https://github.com/archlinux/soloinstall/issues/585
