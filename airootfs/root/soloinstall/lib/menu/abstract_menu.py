...
from soloinstall.tui.curses_menu import SelectMenu, Tui
from soloinstall.tui.menu_item import MenuItem, MenuItemGroup
from soloinstall.tui.result import ResultType
from soloinstall.tui.types import Chars, FrameProperties, FrameStyle, PreviewStyle
...
class AbstractMenu[ValueT]:
	...
	def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: TracebackType | None) -> None:
		...
		if exc_type is not None:
			error(str(exc_value))
			Tui.print('Please submit this issue (and file) to https://github.com/archlinux/soloinstall/issues')
