...
from soloinstall.lib.packages.packages import list_available_packages
from soloinstall.lib.translationhandler import tr
from soloinstall.tui.curses_menu import EditMenu, SelectMenu, Tui
...
def select_soloinstall_language(languages: list[Language], preset: Language) -> Language:
